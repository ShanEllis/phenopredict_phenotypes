...
if(!file.exists("/dcl01/leek/data/sellis/barcoding/data/TCGA_Sex_inputdata.rda")) {
  ...
  TCGA_inputdata$regiondata <- predictor$regiondata
    ...
    save(TCGA_inputdata, tcga_meta2, file="/dcl01/leek/data/sellis/barcoding/data/TCGA_Sex_inputdata.rda")
}else{
  ...
  actual_all = as.character(md2$gdc_cases.demographic.gender)
 ...
 #get output for package
predictions_tcga = as.data.frame(cbind(md2$gdc_file_id,"tcga",actual=actual_all,predicted=predictions,perc_correct))
```
