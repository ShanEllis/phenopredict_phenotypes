...
pdf("plots/Age.pdf", width=10, height=5)
...
## Create the vignette
library('rmarkdown')
system.time(render('/dcl01/leek/data/sellis/barcoding/phenotype_vignettes/phenopredict-Age.Rmd', output_format='html_document'))
