...
regnum <- optimize_numRegions(inputdata=merge_input ,phenodata=pheno, phenotype="BMI", covariates=NULL,type="numeric",numRegions_set=c(10,20,30,60,80,100,150,200,500,1000,2000))
regnum$numRegions
...
## Create the vignette
library('rmarkdown')
system.time(render('/dcl01/leek/data/sellis/barcoding/phenotype_vignettes/phenopredict-BMI.Rmd', 'BiocStyle::html_document'))
