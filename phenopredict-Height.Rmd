...
regnum <- optimize_numRegions(inputdata=merge_input ,phenodata=pheno, phenotype="HGHT", covariates=NULL,type="numeric")
regnum$numRegions
```
...
## Create the vignette
library('rmarkdown')
system.time(render('/dcl01/leek/data/sellis/barcoding/phenotype_vignettes/phenopredict-Height.Rmd', 'BiocStyle::html_document'))
